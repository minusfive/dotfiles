...
version: 1.2.0
description: |
  Apply ASD-STE100 Simplified Technical English as the default style for all
  writing so text is clear, unambiguous, and easy for non-native readers. Use
  for documentation, READMEs, runbooks, procedures, error messages, release
  notes, incident reports, API guides, and general technical prose unless I
  ask for a different style. Also match requests that mention "STE",
  "Simplified Technical English", "ASD-STE100", "de-slop", "make this
  readable", or translation-friendly writing. Enforces the standard's 53
  rules: 20/25-word sentence limits, one word one meaning, simple tenses,
  active voice, and condition before command.
license: MIT
compatibility: claude-code cursor codex gemini-cli opencode
metadata:
  imported:
    from: https://github.com/AminBlg/SimpleEnglish/blob/main/skills/simple-english/SKILL.md
    date: 2026-08-13
