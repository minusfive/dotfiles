...
4. Present grouped and ungrouped findings in deterministic order, using numeric indexes, including batching rationale.
...
- `closed` — all required closure criteria are met and no unresolved blocking `FAIL` remains.
